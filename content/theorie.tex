\section{Theorie}
\label{sec:Theorie}
Zur Vermessung der elektronischen Bauteile muss die Abgleichbedingung der
...
\end{equation}
\\
Ein komplexer Widerstand kann in Real- und Imaginärteil aufgeteilt werden
\begin{equation}
    \xi = x+iy.
\end{equation}
\\
Die somit entstandene komplexe Abgleichbedingung
\begin{equation}
    \xi_1 \xi_4 = \xi_2 \xi_3
    \label{eq: komp1}
\end{equation}
...
Aus den Gleichungen \ref{eq:komp2} und \ref{eq:komp3} ergeben sich die zu ermittelnden
Größen als
\begin{equation}
    R_X=R_2\frac{R_3}{R_4}
    \label{eq:3}
...
Glechungen \ref{eq:komp2} und \ref{eq:komp3} durch
\begin{equation}
    R_x=R_2\frac{R_3}{R_4}
    \label{eq:6}
\end{equation}
...
mit den Gleichungen \ref{eq:komp2} und \ref{eq:komp3} durch
\begin{equation}
    R_x=R_2\frac{R_3}{R_4}
    \label{eq:12}
\end{equation}
