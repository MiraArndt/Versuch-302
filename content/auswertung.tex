...
Nach Umrechnung der Kreisfrequenz $\omega_{0}$ in die Frequenz $\nu_{0}$ mithilfe von 
\begin{equation}
\nu_{0} = frac{\omega_{0}}{2 \cdot np.pi()}
\end{equation}


Nach der Umrechnung der Frequenz $\nu_{0}$ in die Kreisfrequenz $\omega_{0}$
\begin{align}
\omega_{0} = 2 \cdot np.pi() \cdot \nu_{0}
\end{align}

Mittels Gleichung (VERWEIS AUF GLEICHUNG) lässt sich der theoretische Wert für $\nu_{0}$ ermitteln, welcher bei dem 
vorliegenden Versuch den Wert 
\begin{align}
\nu_{0} = frac{1}{\omega_{0} \cdot }
\end{align}
